...
function writeLog() {
  ...
  if (pendingEvents.length > 0) {
    ...
    req.open("POST", servicesRoot + "/services/log/turing");
...
var servicesRoot = isLocal ? "http://localhost:5000" : "https://services.thegamma.net";
var editor;
var setSourceLookup = {};
var lastId;
...
function loadTheGamma() {
  ...
  require(["vs/editor/editor.main", theGammaRoot + "/thegamma.js"], function (_, g) {
    var services = servicesRoot + "/services/";
    var gallery = servicesRoot + "/services/csv/";
    var providers =
      g.providers.createProviders({
        ...
        "expenditure": g.providers.rest(services + "expenditure"),
        "drwho": g.providers.rest(services + "drwho")
      });
